...
namespace EMAPILib
{
    public ref class MsgStoreImpl : public EMAPILib::IEMsgStore, public MAPIPropImpl
    {
    private:
    ...
    public ref class MsgStoresImpl : public EMAPILib::IEMsgStores, public Disposable
    {
    private:
