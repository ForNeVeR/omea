...
#define COM_REASON_T(e)	((e).Description().length() != 0 ? (LPCTSTR)(e).Description() : (e).ErrorMessage())
#ifdef _UNICODE
#define COM_REASON(e)	((e).Description().length() != 0 ? (LPCWSTR)(e).Description() : (e).ErrorMessage())
#else	// _UNICODE
#define COM_REASON(e)	((e).Description().length() != 0 ? (LPCWSTR)(e).Description() : (LPCWSTR)CT2W((e).ErrorMessage()))
#endif	// _UNICODE
