...
either as a blog post or as a new page. If the resource is posted as a new
page, you can select a parent page for that page.

You can also edit the title and text of the page that will be posted.
