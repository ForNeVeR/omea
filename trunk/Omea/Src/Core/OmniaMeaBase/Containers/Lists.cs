...
namespace JetBrains.Omea.Containers
{
    ...
    public class UIntArrayList: ICollection, ICloneable
    {
        private uint[]      _items;
        private int         _size;
        private int         _version;
        ...
        public UIntArrayList()
        {
            _items = new uint [ InitialCapacity ];
        }

        public UIntArrayList( int capacity )
        {
            _items = new uint [capacity];
        }

        public UIntArrayList( ICollection collection )
        {
            _items = new uint [collection.Count];
            AddRange( collection );
        }
        ...
        {
            return new UIntArrayListEnumerator( this );
        }
        ...
        public object Clone()
        {
            UIntArrayList result = new UIntArrayList( _size );
            result._size = _size;
            result._version = _version;
            Array.Copy( _items, 0, result._items, 0, _size );
            return result;
        ...
        {
            if(( index < 0 ) || ( index > _size ))
                throw new ArgumentOutOfRangeException( "insertion index is out of bounds: Index = " + index.ToString() + " + current size = " + _size.ToString() );
        ...
        {
            if ( _size < 0 || _size > _items.Length )
            {
                throw new Exception( "Invalid IntArrayList _size " + _size + ", _items.Length " + _items.Length );
            }
        ...
        public  int     Capacity
        {
            ...
            {
                if( value <= 0 )
                    throw new ArgumentOutOfRangeException( "Array capacity must be positive" );
                uint[] newData = new uint [value];
                Array.Copy( _items, 0, newData, 0, Math.Min( _size, value ) );
        ...
        public int BinarySearch( uint value )
        {
            return Array.BinarySearch( _items, 0, _size, value );
        }

        public int BinarySearch( uint value, IComparer comparer )
        {
            return Array.BinarySearch( _items, 0, _size, value, comparer );
        }
        ...
        private void EnsureCapacity( int requestCapacity )
        {
            if ( _items.Length < requestCapacity )
            {
                int newCapacity = Capacity + Capacity/2 + 1;
                if ( newCapacity > requestCapacity )
        ...
        public static UIntArrayList MergeSorted( UIntArrayList list1, UIntArrayList list2 )
        {
            UIntArrayList result = new UIntArrayList();
            int index1 = 0;
            int index2 = 0;
        ...
        [Serializable()] private class UIntArrayListEnumerator : IEnumerator, ICloneable
        {
            private UIntArrayList _list;
            private int _index;
            private int _version;
						    
            internal UIntArrayListEnumerator( UIntArrayList list ) 
            {
                _list = list;
                _index = -1;
                _version = list._version;
    ...
    public class LongArrayList: ICollection, ICloneable
    {
        private long[]       _items;
        private int         _size;
        private int         _version;
        ...
        {
            _items = new long [ InitialCapacity ];
        }
        ...
        public LongArrayList( ICollection collection )
        {
            _items = new long [ collection.Count ];
            AddRange( collection );
        }
        ...
        public IEnumerator GetEnumerator()
        {
            return new LongArrayListEnumerator( this );
        }
        ...
        public object Clone()
        {
            LongArrayList result = new LongArrayList( _size );
            result._size = _size;
            result._version = _version;
            Array.Copy( _items, 0, result._items, 0, _size );
            return result;
        ...
        public  void  Clear()
        {
            if( _items.Length > InitialCapacity )
            {
                _items = new long[ InitialCapacity ];
            }
            _size = 0;
        ...
        public int BinarySearch( long value, IComparer comparer )
        {
            return Array.BinarySearch( _items, 0, _size, value, comparer );
        }
        ...
        */
        ...
        public static LongArrayList MergeSorted( IntArrayList list1, IntArrayList list2 )
        {
            return MergeSorted( list1, list2, Comparer.Default );
        }

        public static LongArrayList MergeSorted( IntArrayList list1, IntArrayList list2, IComparer comparer )
        {
        ...
        public static LongArrayList IntersectSorted( IntArrayList list1, IntArrayList list2 )
        {
            LongArrayList result = new LongArrayList( Math.Min( list1.Capacity, list2.Capacity ) );
            int index1 = 0;
            int index2 = 0;
            int count1 = list1.Count;
            int count2 = list2.Count;
            while ( index1 < count1 && index2 < count2 )
            {
                int compareResult = list1 [index1] - list2  [index2];
                if ( compareResult == 0 )
                {
                    result.Add( list1 [index1] );
                    index1++;
        ...
        public static LongArrayList IntersectSorted( IntArrayList list1, IntArrayList list2, IComparer comparer )
        {
            LongArrayList result = new LongArrayList( Math.Min( list1.Capacity, list2.Capacity ) );
            int index1 = 0;
            int index2 = 0;
        ...
        [Serializable()] private class LongArrayListEnumerator : IEnumerator, ICloneable
        {
            private LongArrayList _list;
            private int _index;
            private int _version;
						    
            internal LongArrayListEnumerator( LongArrayList list ) 
            {
                _list = list;
                _index = -1;
                _version = list._version;
    ...
    {
        private string _toStringSeparator = ",";
